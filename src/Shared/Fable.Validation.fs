...
#else
[<Literal>]
let private regexOpts = RegexOptions.Compiled ||| RegexOptions.ECMAScript
#endif
...
and Validator<'E>(all) =
    ...
    member __.IsValidOptAsync<'T, 'T0, 'T1>
